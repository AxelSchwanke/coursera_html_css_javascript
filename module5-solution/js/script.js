...
// when the user clicks on the Specials tile, the web app takes the 
// user to a random single category menu page, listing menu items 
// in the category, be it "Lunch", "Dinner", "Sushi", etc. 
